...
<br><br>
      ...
      this.messageSrv.sendSystemMail('employee', this.employeeId, `Bestelling ${this.gs.tenantName}`, '(Deze mail is opgesteld in HTML formaat)', HTMLContent, true)
...
<br><br>
      ` + this.orderHTML(tenant)
      this.messageSrv.sendSystemMail('organisation', this.organisationId, `Bestelling ${this.gs.tenantName}`, '(Deze mail is opgesteld in HTML formaat)', HTMLContent, false)
    })
  }
