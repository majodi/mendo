...
export const defaultFormConfig = [
    ...
    {type: 'input', inputLines: 5,  label: 'Omschrijving lang', name: 'description_l',        placeholder: 'Omschrijving lang', value: '', },
    {
      ...
      value: '',
      customLookupFld: {path: 'categories', tbl: 'category', fld: 'code'},
      customUpdateWithLookup: [{fld: 'measurements', lookupFld: 'measurements', onlyVirgin: true}, {fld: 'colors', lookupFld: 'colors', onlyVirgin: true}]
    },
    {
      type: 'lookup',
      label: 'Afbeelding',
      ...
      value: '', inputValueTransform: forceUppercase, customLookupFld: {path: 'images', tbl: 'image', fld: 'code', overruleVirtual: 'thumbName'}, customUpdateWithLookup: [{fld: 'imagedisplay', lookupFld: 'name'}]
    },
    {type: 'imagedisplay',          label: 'Afbeelding',        name: 'imagedisplay',         placeholder: 'Afbeelding',        value: '', imageStyle: {'width': '65%'}},
    {
      type: 'pulldown',
      label: 'Maten',
      name: 'measurements',
      placeholder: 'Maten',
      value: '',
      customLookupFld: {path: 'properties', tbl: 'property', fld: 'code'}, customUpdateWithLookup: [{fld: 'measurementsChoices', lookupFld: 'choices'}]
    },
    ...
    {type: 'chiplist',              label: 'Maten selectie',    name: 'measurementsOverrule', placeholder: 'Maten selectie',    value: ''},
    {
      ...
      name: 'colors',
      placeholder: 'Kleuren',
      value: '', customLookupFld: {path: 'properties', tbl: 'property', fld: 'code'}, customUpdateWithLookup: [{fld: 'colorsChoices', lookupFld: 'choices'}]
    },
    ...
    {
      type: 'pulldown',
      label: 'In Pakketselectie voor',
      name: 'packageSelectionFor',
      placeholder: 'In Pakketselectie voor',
      value: '',
      doNotPopulate: true,
